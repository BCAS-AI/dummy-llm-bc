...
const ANSWER_POOL = {
  "vllm-text-generation": [
    "Ini adalah jawaban simulasi dari ABC LLM Gateway. Tidak ada model bahasa sungguhan yang dipanggil; teks ini dipilih secara acak dari kumpulan respons statis untuk keperluan pengujian integrasi.",
  ...
  "vllm-coder": [
    ...
    "```javascript\nfunction dummyHandler(req, res) {\n  // Respons contoh dari ABC LLM Gateway simulator.\n  return res.json({ ok: true });\n}\n```",
  ],
  "vllm-vision": [
...
const RECOMMENDATION_POOL = [
  {
    longPrompt:
      "Jelaskan lebih detail mengenai topik sebelumnya dengan menambahkan contoh nyata dan langkah implementasi.",
    shortPrompt: "Jelaskan lebih detail",
  },
  {
    longPrompt:
      "Buatkan ringkasan singkat dari jawaban di atas dalam bentuk poin-poin yang mudah dibaca.",
    shortPrompt: "Ringkas dalam poin-poin",
  },
  {
    longPrompt:
      "Berikan alternatif pendekatan lain untuk menyelesaikan permasalahan yang sama.",
    shortPrompt: "Berikan alternatif lain",
  },
  {
    longPrompt:
      "Terjemahkan jawaban di atas ke dalam Bahasa Inggris secara natural.",
